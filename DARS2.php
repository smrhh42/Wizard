    ...
    <section class="wrapper">
        ...
        <body>
            ...
            <table class="tg">
                ...
                <div>
                    <br/>
                    <button class="collapse" id="collapse-1">Click here to collapse/display the next tabbed section. </button>
                </div>
                </tr>
                ...
                <tr>
                    <th class="tg-031e"></th>
                <div class="tabbed-section" id="list1-tabs">
                    <ul>
                ...
                <tr>
                    <th class="tg-031e"></th>
                <div>
                    <br/><button class="collapse" id="collapse-2">Click here to collapse/display the next tabbed section. </button><br/>
                </div>
                </tr>
                ...
                <tr>
                    <th class="tg-031e"></th>
                <div>
                    <br/><button class="collapse" id="collapse-3">Click here to collapse/display the next tabbed section. </button><br/>
                </div>
                </tr>
                ...
                <tr> <th class="tg-031e"></th> <div> <h4>Qualifying Exams (PhD students only):</h4> </div> </tr>
